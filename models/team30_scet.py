...
class TransformerBlock(nn.Module):
    def __init__(self, dim=48, num_heads=8, ffn_expansion_factor=2.66, bias=False, LayerNorm_type=WithBias_LayerNorm):
        ...
        # hidden_features = int(dim * ffn_expansion_factor)
        # self.ffn = FeedForward(dim, hidden_features)
...
class SCET(nn.Module):
    def __init__(self, hiddenDim=64, mlpDim=128, scaleFactor=4):
        super().__init__()
        ...
        self.path1 = nn.Sequential(
            ...
            BackBoneBlock(1, TransformerBlock,
                          dim=hiddenDim, num_heads=8, ffn_expansion_factor=2.66, bias=False, LayerNorm_type=WithBias_LayerNorm),
